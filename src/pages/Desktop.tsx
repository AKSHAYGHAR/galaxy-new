...
const Desktop = () => {
  const { wallpapers: pexelsWallpapers, isLoading, error, loadMore, loadInitial } = usePexelsWallpapers("landscape");
  ...
  return (
    <div className="min-h-screen bg-black relative isolate">
      ...
      <main className="px-6 md:px-12 lg:px-24 pt-24 pb-24">
        ...
        {/* ── Pexels Landscape Wallpapers ── */}
        <section ref={pexelsSectionRef} className="max-w-6xl mx-auto mt-24">
